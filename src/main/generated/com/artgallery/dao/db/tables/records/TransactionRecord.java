...
public class TransactionRecord extends UpdatableRecordImpl<TransactionRecord> implements Record7<Long, Long, Long, Long, Long, BigDecimal, LocalDate> {
    ...
    @Override
    public Row7<Long, Long, Long, Long, Long, BigDecimal, LocalDate> valuesRow() {
    ...
    @Override
    public TransactionRecord values(Long value1, Long value2, Long value3, Long value4, Long value5, BigDecimal value6, LocalDate value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TransactionRecord(Long id, Long paintingId, Long clientId, Long curatorId, Long bankAccountId, BigDecimal value, LocalDate date) {
        super(Transaction.TRANSACTION);
